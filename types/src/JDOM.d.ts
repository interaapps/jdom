...
declare class JDOM {
    ...
    static registerComponent(tag: string | {
        [x: string]: Node | HTMLElement | typeof JDOMComponent;
    } | Node | HTMLElement | typeof JDOMComponent | (Node | HTMLElement | typeof JDOMComponent)[], component?: Node | HTMLElement | typeof JDOMComponent | undefined): Node | HTMLElement | typeof JDOMComponent;
    /**
